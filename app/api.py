...
def status() -> Dict[str, Any]:
    try:
        ...
        return {
            ...
            "highres": {
                "table": settings.highres_table,
                "time_column": settings.highres_time_column,
                "power_col": settings.highres_power_col,
                "phase_cols": settings.highres_phase_cols,
                "interval_seconds": settings.highres_interval_s,
            },
            "span": span,
